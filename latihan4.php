...
<body>
    <center><h3>Latihan Menampilkan data siswa yang lahir di bulan April</h3></center>
    ...
    <p><a href="latihan5.php">Ke Latihan 5</a></p>
        ...
        <tbody>
            ...
            foreach ($siswa as $anime) {
                // Cek apakah bulan lahir adalah '04' (April)
                if (substr($anime['tanggal_lahir'], 5, 2) == '04') {
            ?>
            <tr>
                <td><?php echo $no++ ?></td>
