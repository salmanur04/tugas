...
<body>
    <center><h3>Latihan Menampilkan data siswa yang lahir di Bandung</h3></center>
    ...
    <p><a href="latihan6.php">Ke Latihan 6</a></p>
        ...
        <tbody>
            ...
            foreach ($siswa as $anime) {
                // Cek apakah tempat lahir adalah "Bandung"
                if (strtolower($anime['tempat_lahir']) == 'bandung') {
            ?>
            <tr>
                <td><?php echo $no++ ?></td>
